...
class Categories_model extends CI_Model
{
    ...
    public function getShopCategories($limit = null, $start = null)
    {
        ...
        foreach ($query->result() as $shop_categorie) {
            ...
            $arr[$shop_categorie->for_id]['show_on_menu'] = $shop_categorie->show_on_menu;
        }
        return $arr;
    }
	...
	public function updateShopCategorie($post, $id)
    {
       if (!$this->db->where('id', $id)->update('shop_categories', array(
        ...
        'show_on_menu' => $post['show_on_menu']
