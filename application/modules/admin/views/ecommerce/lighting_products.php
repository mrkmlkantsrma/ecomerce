<div id="products">
    ...
    ?>
    <h1><img src="<?= base_url('assets/imgs/products-img.png') ?>" class="header-img" style="margin-top:-2px;"> lighting Products</h1>
    <hr>
    <div class="row">
        <div class="col-xs-12">
                                   ...
                                   <td><?= $row->designer_id > 0 ? '<a href="?show_designer=' . $row->designer_id . '">' . $row->designer_name . '</a>' : 'No Designer' ?></td>
                                    ...
                                    <td>
                                        <div class="pull-right">
                                            <a href="<?= base_url('admin/lighting_publish/' . $row->id) ?>" class="btn btn-info">Edit</a>
                                            <a href="<?= base_url('admin/lighting_products?delete=' . $row->id) ?>"  class="btn btn-danger confirm-delete">Delete</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php
