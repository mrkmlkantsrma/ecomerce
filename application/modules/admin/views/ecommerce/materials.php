<div id="products">
    ...
    ?>
    <h1><img src="<?= base_url('assets/imgs/products-img.png') ?>" class="header-img" style="margin-top:-2px;"> Material Samples</h1>
    <hr>
    <a href="<?= base_url('admin/material') ?>" class="btn btn-primary btn-xs pull-right" style="margin-bottom:10px;"><b>+</b> Add Material Sample</a>
    ...
    <div class="row">
        <div class="col-xs-12">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            foreach ($materials as $row) {
                                $u_path = 'attachments/material_images/';
                                ...
                                <tr>
                                    ...
                                    <?php 
									$ctid=$row['m_cat_id'];
									$getmtc= $this->Material_model->getMtcSingle($ctid);?>
                                        <?= $getmtc['title']; ?>
                                    </td>
                                    ...
                                    <td>
                                        <div class="pull-right">
                                            <a href="<?= base_url('admin/material/' . $row['id']) ?>" class="btn btn-info">Edit</a>
                                            <a href="<?= base_url('admin/materials?delete=' . $row['id']) ?>"  class="btn btn-danger confirm-delete">Delete</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php
            ...
            ?>
            <div class ="alert alert-info">No Material Design Option found!</div>
        <?php } ?>
    </div>