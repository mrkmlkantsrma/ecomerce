...
<h1><img src="<?= base_url('assets/imgs/shop-cart-add-icon.png') ?>" class="header-img" style="margin-top:-3px;"> Publish Sub Category Related product</h1>
<hr>
<?php
...
<form method="post" id="relatedProduct" enctype="multipart/form-data">
    <div class="form-group">
        ...
        <select class="form-control for-shop" name="main_category" id="Cat_select" required>
            ...
            <option value="51">FineArt</option>
        </select>
    </div>
