			...
			<div class="row">
				<div class="col-sm-6">
					<div class="about_text wow slideInLeft">
						<h1>Sugacci - The Brand</h1>
						<h2>we believe in your perfume-signature</h2>
						<p>Inspired by your thumb-print, at Sugacci, we believe in your perfume-signature, Perfumes for Men and Women; here are made from finest natural, hand-picked perfume oil ingredients to result into an extraordinary perfume experience.</p>
						<p>Leave your mark with your fragrance, wherever you go. Every perfume is made in Eau de Parfum concentration, 10 TIMES MORE LASTING than ordinary deodorants, body mists.</p>
	...
	<div id="products" class="products_section">
		<div class="container-fluid">
			<div class="heading_wrapper wow fadeInDown animated">
				...
				<p class="wow fadeInDown animated">We provide the best alternative to deodorants and body mists which is 10 times more long lasting because all our unisex perfumes are made with Eau de Parfum concentration which makes it last longer.</p>
			</div>
			<div class="row">
		...
		<div class="row">
			<div class="col-sm-6 condition-set">
				<div class="astrologers_title">
					<h2 class="wow fadeInDown animated">Why Sugacci?</h2>
					<p class="wow fadeInDown animated">Sugacci is a perfumes brand which aims on providing high quality and long lasting perfumes for men and women at affordable prices.</p>
					<p class="wow fadeInDown animated">Perfumes, deodorants, body mists and fragrances are nowadays bifurcated as Men & Women but at Sugacci; we create unisex fragrances which can used both by men and women. This definitely ads economic value to the perfumes we make.</p>
					<p class="wow fadeInDown animated">The current portfolio of Sugacci includes 10 exciting variants in the Eau De Parfum concentration and are crafted to last longer with unique combination of perfume notes giving you an excellent fragrance experience.</p>
				</div>
			</div>
