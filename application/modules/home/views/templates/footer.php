...
<footer id="footer" class="footer">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="footer_logo_wrapper">
						...
						<h2 class="wow fadeInDown animated">Contact Detail</h2>
						   <ul>
								<li><i class="fa fa-map-marker"></i> 202, Dishabhumi, Ambegaon Bk,</li>
								<li><i class="fa fa-map-marker"></i> Pune - 411046. MH India.</li>
								<li><i class="fa fa-phone"></i> Phone. +91 98602 87405</li>
								<li><i class="fa fa-fax"></i> Fax. +91 98602 87405</li>
								<li><i class="fa fa-envelope"></i> Email: feedback@sugacci.com</li>
	...
	<div class="footer_copyright">
		<div class="container-fluid">
			<p class="wow fadeInDown animated">© Copyright 2022, Sugacci Perfumes Powered by Pineapple</p>
		</div>
	</div>
