// start select to library productReorder

var script = document.createElement("SCRIPT");
script.src = 'https://www.v4designspecialists.com/assets/select2/dist/js/select2.min.js';
script.type = 'text/javascript';
script.onload = function() {

let productReorder = jQuery('#selectedProductsOLD');
productReorder.on('select2:select', function(e){
...
productReorder.select2();

};
document.getElementsByTagName("head")[0].appendChild(script);

// end select to library productReorder
