...
$(document).ready(function () {
    ...
    $('#slideWiz').slideWiz({
        ...
        file: [
            {
                src: {
                    main: "assets/image/silder/slider-3.jpeg",
            ...
            {
                src: {
                    main: "assets/image/silder/slider-6.jpeg",
            ...
            {
                src: {
                    main: "assets/image/silder/slider-1.jpeg",
            ...
            },
            {
                src: {
                    main: "assets/image/silder/slider-6.jpeg",
                    cover: "assets/image/silder/slider-5.jpg"
                },
                title: 'Banner 4',
                desc: "If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. or randomised words which don't look even slightly believable.",
                button: {
